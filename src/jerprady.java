...
public class jerprady implements ActionListener {
...
frame.setVisible(true);
		...
		JPanel panel = createHeader("Money") ;
...
fifthButton.addActionListener(this);
	...
	//	JOptionPane.showMessageDialog(null,"pressed " + ((JButton)arg0.getSource()).getText() + " button");
		...
		if (buttonPressed==firstButton){
			askQuestion("how much money is $200", "$200" , 200);
		}
		if (buttonPressed==fourthButton){
			askQuestion("how much money did finding dory make?", "$422 million" , 800);
		}
		if (buttonPressed==thirdButton){
			askQuestion("how much money did huricain sandy cost", "$100 billion" , 600);
		}
		if (buttonPressed==secondButton){
			askQuestion("how much money is amazon prime per year", "$99" , 400);
		}
	...
	String x=JOptionPane.showInputDialog(question);
		...
		if (x.equals(correctAnswer)){
			...
			updateScore();
			JOptionPane.showMessageDialog(null, "Correct, you have $" + score);
		}
		...
		// Otherwise
				...
				updateScore();
				JOptionPane.showMessageDialog(null, "Incorrect, you have $" + score);
